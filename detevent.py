...
class CurrentPosition(correct.CalcPosition):
  ...
  def RelRef(self):
    ...
    if prefs.RefractionOn:
      ...
      print "Old refraction: ", oldRAref,oldDECref
    else:
      oldRAref = 0
      oldDECref = 0
    ...
    if prefs.FlexureOn:
      ...
      print "Old flexure: ", oldRAflex,oldDECflex
    else:
      oldRAflex = 0
      oldDECflex = 0
    ...
    if prefs.RefractionOn:
      ...
      print "New refraction: ", newRAref, newDECref
    else:
      newRAref = 0.0
      newDECref = 0.0
    ...
    if prefs.FlexureOn:
      ...
      print "New flexure: ", newRAflex, newDECflex
    else:
      newRAflex = 0.0
      newDECflex = 0.0
