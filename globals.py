...
class Prefs(object):
    ...
    def __init__(self):
        ...
        self.RealTimeOn = CP.getboolean('Toggles',
                                        'RealTimeOn')  # real-time refraction and/or flexure corrections if on
...
def UpdateConfig():
    ...
    for section in ['Toggles', 'Environment', 'Presets', 'Paths', 'FlexureEast', 'FlexureWest', 'Alarms', 'Rates',
                    'Dome']:
...
ConfigDefaults = {'FlexureOn': 'True', 'HighHorizonOn': 'False', 'RefractionOn': 'True',
                  ...
                  'CoarseSet': str(DFCOARSESETRATE / 20), 'FineSet': str(DFFINESETRATE / 20),
                  'GUIDE': str(DFGUIDERATE / 20),
