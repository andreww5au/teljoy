...
class Driver(controller.Driver):
  ...
  def _initialisation_exception_wait_completed(self):            # Nothing calls this method, and I found it broken. AW
  ...
  def _turn_output_on(self):
    ...
    self.host.force_outputs((2 ** 48)-1)
